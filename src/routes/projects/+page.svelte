<script lang="ts">
    ...
    const data = [
        ...
        {title: "Mental Health and Police Violence V1", desc_short: "Exploring the role of mental health in police violence in the US.", route: `${base}/projects/police-shootings`},
        ...
        {title: "Mental Health & Fatal Police Shootings in Asian communities", desc_short: "Exploring the role of mental health in fatal police shootings of Asian communities in the US.", route: `${base}/projects/pmh-asians`}]
